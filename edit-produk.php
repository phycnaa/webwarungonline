			...
			<div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
					<select class="input-control" name="kategori" required>
						...
						<?php
						$kategori = mysqli_query($conn, "SELECT * FROM tb_category ORDER BY category_id DESC");while($r = mysqli_fetch_array($kategori)){
						 ?>
					...
					<input type="hidden" name="foto" value="<?php echo $p->product_name ?>">
					<input type="file" name="gambar" value="<?php echo $p->product_name ?>">
